...
\subsection{Configuration des GPIO}
    ...
    \begin{itemize}
        ...
        \item \textbf{LED bleue} : Pin PC13 - Indicateur de mode 1 (servo contrôlé par distance)
        \item \textbf{LED verte} : Pin PC14 - Indicateur de mode 2 (servo contrôlé par liaison série)
