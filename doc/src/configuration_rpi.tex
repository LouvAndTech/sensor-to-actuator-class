...
\subsection{Gestion des LOG et des ERREURs}
    Toute les erreurs sont normalment gérées par les différent modules qui font à leurs tour remonter les erreurs au module appelant.
